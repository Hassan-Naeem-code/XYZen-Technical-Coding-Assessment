...
class Util {
  ...
  normalizeUrl = (url) => {
    if (typeof url !== "string" || url.trim() === "") {
      return ""; // or you can throw an error or handle it differently
    }
  ...
  getDayMinMaxTemps = (hourlyTemps, hourlyTimes, dayIdx) => {
    // Each day has 24 hours, so get the slice for this day
